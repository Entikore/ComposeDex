...
/**
 * Represents an update to a [PokemonEntity]'s artwork.
 *
 * This data class holds information about the Pokémon whose artwork is being updated
 ...
 */
data class ArtworkUpdate(val pokemonId: Int, val localArtwork: String)
